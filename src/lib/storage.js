...
const SEED_DATA = {
    users: [
        ...
        },
        {
            ...
            firstName: 'Olivia',
            lastName: 'Nguyen',
            email: 'olivia@kitchenodyssey.com',
            password: 'admin',
            birthday: '1986-04-12',
            role: 'admin',
            status: 'inactive',
        ...
        },
        {
            ...
            firstName: 'Marcus',
            lastName: 'Lee',
            email: 'marcus@kitchenodyssey.com',
            password: 'admin',
            birthday: '1983-11-22',
            role: 'admin',
            status: 'inactive',
        ...
        },
        {
            ...
            firstName: 'Maria',
            lastName: 'Garcia',
            email: 'maria@kitchenodyssey.com',
            password: 'maria123',
            birthday: '1988-03-20',
            role: 'user',
            status: 'inactive',
        ...
        },
        {
            ...
            firstName: 'Kevin',
            lastName: 'Tran',
            email: 'kevin@kitchenodyssey.com',
            password: 'kevin123',
            birthday: '1996-02-18',
            role: 'user',
            status: 'pending',
        ...
        },
        {
            ...
            firstName: 'Sarah',
            lastName: 'Kim',
            email: 'sarah@kitchenodyssey.com',
            password: 'sarah123',
            birthday: '1991-07-09',
            role: 'user',
            status: 'inactive',
        ...
        },
        {
            ...
            firstName: 'Daniel',
            lastName: 'Rivera',
            email: 'daniel@kitchenodyssey.com',
            password: 'daniel123',
            birthday: '1989-05-30',
            role: 'user',
            status: 'inactive',
