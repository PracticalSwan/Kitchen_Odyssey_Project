...
const STORAGE_KEYS = {
    USERS: 'kitchen_odyssey_users',
    RECIPES: 'kitchen_odyssey_recipes',
    CURRENT_USER: 'kitchen_odyssey_current_user',
    GUEST_ID: 'kitchen_odyssey_guest_id',
    REVIEWS: 'kitchen_odyssey_reviews',
    SEARCH_HISTORY: 'kitchen_odyssey_search_history',
    DAILY_STATS: 'kitchen_odyssey_daily_stats',
    ACTIVITY: 'kitchen_odyssey_activity'
};
    ...
    users: [
        {
            ...
            firstName: 'Admin',
            lastName: 'User',
            email: 'admin@kitchen_odyssey.com',
            password: 'admin',
            birthday: '1990-01-01',
            role: 'admin',
            status: 'inactive',
        ...
        },
        {
            ...
            firstName: 'Olivia',
            lastName: 'Nguyen',
            email: 'olivia@kitchen_odyssey.com',
            password: 'admin',
            birthday: '1986-04-12',
            role: 'admin',
            status: 'inactive',
        ...
        },
        {
            ...
            firstName: 'Marcus',
            lastName: 'Lee',
            email: 'marcus@kitchen_odyssey.com',
            password: 'admin',
            birthday: '1983-11-22',
            role: 'admin',
            status: 'inactive',
        ...
        },
        {
            ...
            firstName: 'John',
            lastName: 'Doe',
            email: 'user@kitchen_odyssey.com',
            password: 'user',
            birthday: '1995-06-15',
            role: 'user',
            status: 'inactive',
        ...
        },
        {
            ...
            firstName: 'Maria',
            lastName: 'Garcia',
            email: 'maria@kitchen_odyssey.com',
            password: 'maria123',
            birthday: '1988-03-20',
            role: 'user',
            status: 'inactive',
        ...
        },
        {
            ...
            firstName: 'Kevin',
            lastName: 'Tran',
            email: 'kevin@kitchen_odyssey.com',
            password: 'kevin123',
            birthday: '1996-02-18',
            role: 'user',
            status: 'pending',
        ...
        },
        {
            ...
            firstName: 'Sarah',
            lastName: 'Kim',
            email: 'sarah@kitchen_odyssey.com',
            password: 'sarah123',
            birthday: '1991-07-09',
            role: 'user',
            status: 'inactive',
        ...
        },
        {
            ...
            firstName: 'Daniel',
            lastName: 'Rivera',
            email: 'daniel@kitchen_odyssey.com',
            password: 'daniel123',
            birthday: '1989-05-30',
            role: 'user',
            status: 'inactive',
        ...
        },
        {
            ...
            firstName: 'Lina',
            lastName: 'Patel',
            email: 'lina@kitchen_odyssey.com',
            password: 'lina123',
            birthday: '2000-09-14',
            role: 'user',
            status: 'inactive',
        ...
        },
        {
            ...
            firstName: 'Omar',
            lastName: 'Hassan',
            email: 'omar@kitchen_odyssey.com',
            password: 'omar123',
            birthday: '1993-03-03',
            role: 'user',
            status: 'pending',
