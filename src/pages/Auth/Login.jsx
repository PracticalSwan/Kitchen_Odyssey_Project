    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid grid-cols-2 gap-3">
                <button
                    type="button"
                    className="inline-flex items-center justify-center gap-2 rounded-lg border border-cool-gray-20 bg-white px-4 py-2.5 text-sm font-medium text-cool-gray-90 transition-colors hover:bg-cool-gray-10"
            ...
            <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-white px-3 text-cool-gray-40">or continue with email</span>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1">
                    ...
                    <div className="flex justify-end">
                        <Link to="#" className="text-sm font-medium text-cool-gray-60 hover:text-brand-accent transition-colors">Forgot password?</Link>
                    </div>
                </div>
            ...
            <div className="text-center text-xs text-cool-gray-30 mt-4 space-y-0.5">
                <p className="font-medium text-cool-gray-40">Demo Credentials</p>
